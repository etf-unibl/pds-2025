...
set_output_delay -clock clk_virt -max 0.550 [get_ports {bcd1_o[*] bcd2_o[*] bcd3_o[*] bcd4_o[*]}]
set_output_delay -clock clk_virt -min 0.350 [get_ports {bcd1_o[*] bcd2_o[*] bcd3_o[*] bcd4_o[*]}]
